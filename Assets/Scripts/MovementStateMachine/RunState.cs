...
public class RunState : MovementBaseState
{
    ...
    {
        manager.Controller.PlayerData.Animator.SetBool("Running", true);
    }
    ...
    public override void UpdateState(MovementStateManager manager)
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift)) manager.SwitchState(manager.WalkState);
    ...
    public override void FixedUpdateState(MovementStateManager manager)
    {
        if (manager.Controller.PlayerData.Direction != Vector2.zero)
        {
            ...
            manager.Controller.PlayerData.RB.velocity = moveDirection.normalized * manager.Controller.PlayerData.RunSpeed * Time.fixedDeltaTime;
        }
    }
    public override void ExitState(MovementStateManager manager)
    {
        manager.Controller.PlayerData.Animator.SetBool("Running", false);
    }
}
